...
**/
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).shave = t();
}(void 0, function () {
  "use strict";
      ...
      for (var c = 0; c < i.length; c += 1) {
        ...
        if (!(g.length < 2)) {
          ...
          if (h.maxHeight = "none", l.offsetHeight <= t) h.height = u, h.maxHeight = p;else {
            for (var m = g.length - 1, x = 0, y = void 0; x < m;) {
              y = x + m + 1 >> 1, l[f] = s ? g.slice(0, y).join(" ") : g.slice(0, y), l.insertAdjacentHTML("beforeend", r), l.offsetHeight > t ? m = y - 1 : x = y;
            }
