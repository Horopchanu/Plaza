domReady(() => {
  ...
  const modalGallerySlider = document.querySelector(".modal-gallery-slider");
  if (modalGallerySlider) {
    const modalGallerySliderInstance = new Swiper(modalGallerySlider, {
      speed: 500,
  ...
  if (modalRecommendSlider) {
    const modalRecommendSliderInstance = new Swiper(modalRecommendSlider, {
      speed: 500,
      slidesOffsetBefore: 10,
      slidesOffsetAfter: 10,
      spaceBetween: 10,
